...
function buildFixtureSet(): FixtureSet {
  ...
  const bracketMatchups = [
    matchup({
      ...
      highSeed: 9,
      lowSeed: 16,
      tally: { highWins: 4, lowWins: 6, winner: "low" },
    ...
    matchup({
      ...
      highSeed: 10,
      lowSeed: 15,
      tally: { highWins: 5, lowWins: 4, ties: 1, winner: "high" },
      lockedAt: "2026-09-14T03:00:00.000Z",
      settledAt: "2026-09-16T03:00:00.000Z",
    }),
    matchup({
      ...
      highSeed: 11,
      lowSeed: 14,
      tally: { highWins: 4, lowWins: 5, ties: 1, winner: "low" },
      lockedAt: "2026-09-14T03:00:00.000Z",
    }),
    matchup({
      id: "r1m4",
    ...
    matchup({
      ...
      highSeed: 16,
      lowSeed: 10,
      tally: { highWins: 6, lowWins: 4, winner: "high" },
